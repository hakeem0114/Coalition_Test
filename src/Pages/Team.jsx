  ...
  return (
    <div id='team' name='team' className=' flex flex-col ' >
            ...
            <div className=' w-full flex justify-around items-center h-24 bg-gray-600 '> 
                    ...
                    <div className='opacity-75 flex font-bold text-lg text-blue-300 uppercase   gap-14  '> 
                      <a className='opacity-75 hover:scale-[1.04]  transition-all ease-in-out duration-300 delay-75 italic uppercase'  href="#history"><p>Copyright 2016. All Rights reserved. </p></a>
                   </div>
            </div>
